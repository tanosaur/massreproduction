...
class OurModel(QtCore.QAbstractItemModel):

    """INPUTS: Node, QObject"""
    def __init__(self, root, parent=None):
        super(OurModel, self).__init__(parent)
        self._rootNode = root
...
if __name__=="__main__":
  ...
  # returns index of item in model
  rightPirateLeg = model.index(0, 0, QtCore.QModelIndex())
  model.insertRows(1, 3, rightPirateLeg)
  model.insertLights(1, 3 , rightPirateLeg)
